export default {
  ...
  listColumnTemplateTitle: 'Column template {index}',
  listGridTemplateTitle: 'Grid template {index}',
  showPageNumber: 'Show page number',
  hidePageTotal: 'Hide page total',
  flowTemplateRemind: 'Provide an adaptive layout that automatically adjusts its position based on changes in the components within the list.'
}
